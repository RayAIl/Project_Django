...
def cart_add(request, item_id):
    ...
    if size:
        try:
            ...
            clothing_item_size = ClothingItemSize.objects.get(clothing_item=clothing_item, size=size_obj)
        ...
        available_sizes = clothing_item.sizes.filter(clothingitemsize_available=True)
